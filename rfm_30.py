...
def perform_clustering(rfm_data):
   ...
   # 将字典转换为 Pandas DataFrame
    ...
    # 保存聚类结果到 JSON 文件
    clustering_output_file = os.path.join(output_dir, "clustering_results_30.json")
    ...
    ax.set_title('30G数据集 RFM 三维聚类分析结果', fontsize=12)
    ...
    # 保存可视化图表
    clustering_plot_file = os.path.join(output_dir, "rfm_clustering_3d_30.png")
...
if __name__ == "__main__":
    ...
    # 定义输出文件路径
    summary_output_file = os.path.join(output_dir, "summary_results_30.json")
